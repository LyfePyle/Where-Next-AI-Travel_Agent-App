        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover hidden gems, local favorites, and must-see destinations around the world. 
              Get AI-powered insights and authentic travel experiences.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <p className="text-gray-600">
            Found <span className="font-semibold text-blue-600">{filteredDestinations.length}</span> amazing places
